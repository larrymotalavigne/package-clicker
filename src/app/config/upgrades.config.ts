    ...
    tiers: [
      {
        ...
        flavor: 'Built to last the extra mile.',
      },
      {
        count: 5,
        price: 500,
        name: 'GPS Navigation',
        flavor: 'Never lost, always delivering. Unlike that one DEX 07.',
      },
      {
        count: 25,
        price: 10000,
        name: 'Turbo Engine',
        flavor: 'Faster than FedEx Priority Overnight.',
      },
      {
        count: 50,
        price: 500000,
        name: 'Fleet Automation',
        flavor: 'They drive themselves now. DEBRIEF still flags them.',
      },
      {
        count: 100,
        price: 50000000,
        name: 'Quantum Trucks',
        flavor: 'Delivers before you order. POD pre-scanned.',
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        price: 1000,
        name: 'Conveyor Belts',
        flavor: 'Packages flow like rivers.',
      },
      {
        count: 5,
        price: 5000,
        name: 'Barcode Scanners',
        flavor: 'Beep. Beep. VAN scan registered. Efficiency.',
      },
      {
        count: 25,
        price: 50000,
        name: 'Robotic Arms',
        flavor: 'Sorting at light speed.',
      },
      {
        count: 50,
        price: 5000000,
        name: 'AI Sorting',
        flavor: 'The machine knows where it goes.',
      },
      {
        count: 100,
        price: 500000000,
        name: 'Quantum Sorter',
        flavor: 'Sorted in all timelines.',
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        price: 11000,
        name: 'Loading Docks',
        flavor: 'More docks, more throughput.',
      },
      {
        count: 5,
        price: 55000,
        name: 'Forklift Fleet',
        flavor: 'Lifting spirits and packages.',
      },
      {
        count: 25,
        price: 550000,
        name: 'Automated Shelving',
      ...
      },
      {
        ...
        price: 55000000,
        name: 'Drone Delivery',
        flavor: 'The sky is full of packages.',
      },
      {
        count: 100,
        price: 5500000000,
        name: 'Teleport Pads',
        flavor: 'From A to B, instantly.',
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        flavor: 'Going the extra distance.',
      },
      {
        count: 5,
        price: 600000,
        name: 'Cargo Hold Upgrade',
        flavor: 'Double the capacity.',
      },
      {
        count: 25,
        price: 6000000,
        name: 'Supersonic Jets',
        flavor: 'Breaking the sound barrier.',
      },
      {
        count: 50,
        price: 600000000,
        name: 'Stealth Delivery',
        flavor: 'You never see them coming.',
      },
      {
        count: 100,
        price: 60000000000,
        name: 'Space Planes',
        flavor: 'Orbit express delivery.',
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        price: 1300000,
        name: 'Bigger Hulls',
        flavor: 'More room for boxes.',
      },
      {
        count: 5,
        price: 6500000,
        name: 'Container Stacking',
        flavor: 'Higher and higher they go.',
      },
      {
        count: 25,
        price: 65000000,
        name: 'Nuclear Engine',
        flavor: 'Never needs to refuel.',
      },
      {
        count: 50,
        price: 6500000000,
        name: 'Submarine Route',
        flavor: 'Underwater express lane.',
      },
      {
        count: 100,
        price: 650000000000,
        name: 'Leviathan Class',
        flavor: 'A ship the size of a city.',
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        flavor: 'They keep coming back.',
      },
      {
        count: 5,
        price: 70000000,
        name: 'Express Counter',
        flavor: 'Skip the line privilege.',
      },
      {
        count: 25,
        price: 700000000,
        name: 'Franchise Model',
        flavor: 'A store on every corner.',
      },
      {
        count: 50,
        price: 70000000000,
        name: 'Global Chain',
        flavor: 'From Tokyo to Toronto.',
      },
      {
        count: 100,
        price: 7000000000000,
        name: 'Dimensional Stores',
        flavor: 'Open in every universe.',
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        flavor: 'Perfect package conditions.',
      },
      {
        count: 5,
        price: 1000000000,
        name: 'Robot Workers',
        flavor: 'They never take breaks.',
      },
      {
        count: 25,
        price: 10000000000,
        name: 'Underground Vaults',
        flavor: 'Miles of storage below.',
      },
      {
        count: 50,
        price: 1000000000000,
        name: 'Floating Warehouses',
        flavor: 'Storage in the sky.',
      },
      {
        count: 100,
        price: 100000000000000,
        name: 'Pocket Dimension',
        flavor: 'Infinite storage, zero space.',
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        price: 3300000000,
        name: 'Extra Runways',
        flavor: 'More flights, more packages.',
      },
      {
        count: 5,
        price: 16500000000,
        name: 'Hub Status',
        flavor: 'Memphis SuperHub status achieved. Fred Smith approves.',
      },
      {
        count: 25,
        price: 165000000000,
        name: 'Space Elevator',
        flavor: 'Why fly when you can ride?',
      },
      {
        count: 50,
        price: 16500000000000,
        name: 'Orbital Platform',
        flavor: 'Above the clouds.',
      },
      {
        count: 100,
        price: 1650000000000000,
        name: 'Warp Gate',
        flavor: 'Anywhere in an instant.',
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        price: 51000000000,
        name: 'Better Rockets',
        flavor: 'Higher, faster, stronger.',
      },
      {
        count: 5,
        price: 255000000000,
        name: 'Mars Colony Route',
        flavor: 'Next stop: the red planet.',
      },
      {
        count: 25,
        price: 2550000000000,
      ...
      },
      {
        ...
        name: 'Dyson Sphere',
        flavor: 'Powered by the sun itself.',
      },
      {
        count: 100,
        price: 25500000000000000,
        name: 'Universal Post',
        flavor: 'Delivering across galaxies.',
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        flavor: 'Corner office with a view.',
      },
      {
        count: 5,
        price: 3750000000000,
        name: 'Board of Directors',
        flavor: 'Synergy at the highest level.',
      },
      {
        count: 25,
        price: 37500000000000,
        name: 'World Domination',
        flavor: "Every company is now FedEx. C'est pas faux.",
      },
      {
        count: 50,
        price: 3750000000000000,
        name: 'Time Travel Inc.',
        flavor: 'Delivered yesterday. K-API response time: -24 hours.',
      },
      {
        count: 100,
        price: 375000000000000000,
        name: 'Omniscient CEO',
        flavor: 'Knows every package. Every scan. Every non-compliant trip.',
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        flavor: 'Tracking packages from space. DEBRIEF goes orbital.',
      },
      {
        count: 5,
        price: 50000000000000,
        name: 'GPS Constellation',
        flavor: '24 satellites, 24/7 coverage. No blind spots.',
      },
      {
        count: 25,
        price: 500000000000000,
        name: 'Quantum Uplink',
        flavor: 'Data moves faster than light. Physicists concerned.',
      },
      {
        count: 50,
        ...
        name: 'Dyson Swarm',
        flavor:
          'A million satellites. The sun wears a belt of tracking beacons.',
      },
      {
        count: 100,
        price: 5e18,
        name: 'Omniscient Array',
        flavor: 'Sees every package in every timeline.',
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        flavor: "Yesterday's deliveries, today!",
      },
      {
        count: 5,
        price: 700000000000000,
        name: 'Paradox Engine',
        flavor: 'Delivering to yourself from the future. K-API: confused.',
      },
      {
        count: 25,
        price: 7000000000000000,
        name: 'Causal Loop',
        flavor: 'The package was always there. It just needed you to click.',
      },
      {
        count: 50,
        price: 700000000000000000,
        name: 'Eternity Drive',
        flavor: 'All of time is just one long delivery route.',
      },
      {
        count: 100,
        price: 7e19,
        name: 'Omega Point',
        flavor:
          'Past, present, future — all packages delivered simultaneously.',
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        flavor: 'One portal, infinite deliveries.',
      },
      {
        count: 5,
        price: 10000000000000000,
        name: 'Dimensional Hub',
        flavor: 'FedEx operates in 47 parallel realities. "On en a gros!"',
      },
      {
        count: 25,
        price: 1e17,
        name: 'Reality Mesh',
        flavor: 'Every universe gets next-day delivery.',
      },
      {
        count: 50,
        price: 1e19,
        name: 'Cosmic Weave',
        flavor: 'The fabric of spacetime IS the delivery network.',
      },
      {
        count: 100,
        price: 1e21,
        name: 'Absolute Infinity',
        flavor: 'There is nothing but packages. There was never anything else.',
      },
    ],
  },
];
...
const COST_REDUCTION_UPGRADES: UpgradeConfig[] = [
  ...
  },
  {
    ...
    price: 500000000,
    icon: '\u{1F3F7}\u{FE0F}',
    effects: [{ type: 'building_cost_reduction', value: 0.9 }],
...
const OFFLINE_UPGRADES: UpgradeConfig[] = [
  ...
  },
  {
    ...
    price: 100000000,
    icon: '\u{1F319}',
    effects: [{ type: 'offline_mult', value: 0.5 }],
