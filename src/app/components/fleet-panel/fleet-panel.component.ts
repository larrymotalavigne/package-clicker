...
@Component({
          ...
          @for (route of routes; track route.id) {
            ...
            >
              <div class="card-top">
                ...
                <div class="r-bonus">+{{ bonusPctDisplay(route) }}%</div>
              </div>
              ...
              <div class="req-list">
                @for (req of route.requirement; track req.buildingType) {
                  ...
                  >
                    ...
                    <div class="req-track">
                      <div class="req-fill" [style.width.%]="reqPct(req)"></div>
                    </div>
                  </div>
                }
              </div>
  ...
  styles: [
    `
      ...
      .req-bar.met .req-label {
        color: #7cc576;
      }
      .req-bar.unmet .req-label {
      ...
      .req-bar.met .req-fill {
        background: #7cc576;
      }
      .req-bar.unmet .req-fill {
