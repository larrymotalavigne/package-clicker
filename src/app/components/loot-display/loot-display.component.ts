  ...
  styles: [
    `
      .loot-toast {
        ...
        z-index: 2100;
        animation:
          lootIn 0.4s cubic-bezier(0.34, 1.56, 0.64, 1),
          lootOut 0.3s ease-in 3.5s forwards;
