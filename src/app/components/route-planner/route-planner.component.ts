      ...
      <div class="rp-panel">
        @switch (phase()) {
          @case ('intro') {
            ...
            <p class="rp-desc">
              Plan the most efficient delivery route! Visit all 9 cities with
          ...
          @case ('playing') {
            <div class="rp-header">
              <span class="rp-dist"
                >Distance: {{ totalDistance().toFixed(1) }}</span
              >
              <span class="rp-count"
                >{{ route().length }} / {{ cityCount }}</span
              >
            </div>
            <div class="map-area">
              <svg
            ...
            <div class="rp-actions">
              ...
              @if (route().length === cityCount) {
                <button class="rp-btn rp-finish" (click)="finishRoute()">
                  Finish Route
                </button>
              }
            </div>
          ...
          @case ('results') {
            ...
            <button class="rp-btn" (click)="claimReward()">Claim Reward</button>
          }
        }
      </div>
    </div>
